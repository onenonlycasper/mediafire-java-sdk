        ...
        switch (this.value) {
            ...
            case 150:
                returnMessage = "One or more files are too large to be included. Files must be "
                        + ZIP_MAX_FILESIZE_READABLE + " or less in order to be included in the zip file.";
                break;
            case 151:
                returnMessage = "The item you selected contained no files. You must select at least one file to zip";
                break;
            case 152:
            ...
            case 156:
                ...
                break;
            case 157:
                returnMessage = "Neither the owner of the files nor you have enough bandwidth to download the zip file";
                break;
            case 158:
            ...
            case 166:
                ...
                break;
            case 167:
                returnMessage = "Maximum depth of folder reached. Cannot add more than " + FOLDER_DEPTH_LIMIT;
                break;
            case 168:
            ...
            case 244:
                ...
                break;
            default:
                returnMessage = "Unkown response code";
        }
