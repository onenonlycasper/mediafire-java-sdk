...
public class FileSystemItem {
  ...
  public String toString() {
    ...
    strb.append("key: ").append(getKey()).append(", ");
    strb.append("parentFolderKey: ").append(getParentFolderKey()).append(", ");
    strb.append("isFolder: ").append(isFolder()).append(", ");
    strb.append("name: ").append(getName()).append(", ");
    strb.append("mimeType: ").append(getMimeType()).append(", ");
    strb.append("description: ").append(getDescription()).append(", ");
    strb.append("createdDate: ").append(getCreatedDate()).append(", ");
    strb.append("isShared: ").append(isShared()).append(", ");
    strb.append("isSharedFromOther: ").append(isSharedFromOther()).append(", ");
    strb.append("size: ").append(getSize()).append(", ");
    strb.append("hash: ").append(getHash()).append(", ");
    strb.append("revisionEpoch: ").append(getRevisionEpoch()).append(", ");
    strb.append("revision: ").append(getRevision());
