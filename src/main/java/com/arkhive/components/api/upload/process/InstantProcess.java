...
public class InstantProcess implements Runnable {
  ...
  private Map<String, String> generateRequestParameters(String filename) {
    ...
    keyValue.put("upload_folder_key", uploadItem.getFileUploadOptions().getUploadFolderKey());
    keyValue.put("action_on_duplicate", uploadItem.getFileUploadOptions().getActionOnDuplicate());
    return keyValue;
  }
