    ...
    public String toString() {
        ...
        switch(this.value) {
          ...
          case 14:        returnMessage = "Upload succeeded but the folder specified does not exist, "
                                            + "so the file was placed in the root folder"; break;
          case -1:
          case -8:
          case -11:       returnMessage = "Dropbox key is invalid"; break;
          case -21:
          case -22:       returnMessage = "Invalid Dropbox Configuration"; break;
          case -31:
          case -40:       returnMessage = "Unknown upload error"; break;
          case -32:       returnMessage = "Missing file Data"; break;
          case -41:       returnMessage = "The uploaded file exceeds the upload_max_filesize"; break;
          case -42:       returnMessage = "The uploaded file exceeds the MAX_FILE_SIZE directive "
                                              + "that was specified in the HTML form"; break;
          case -43:       returnMessage = "The uploaded file was only partially uploaded"; break;
          case -44:       returnMessage = "No file was uploaded"; break;
          case -45:       returnMessage = "Missing a temporary folder"; break;
          case -46:       returnMessage = "Failed to write file to disk"; break;
          case -47:       returnMessage = "A PHP extension stopped the file upload"; break;
          case -48:       returnMessage = "Invalid file size"; break;
          case -49:       returnMessage = "Missing file name"; break;
          case -51:       returnMessage = "File size does not match size on disk"; break;
          case -90:       returnMessage = "The Hash sent mismatch the actual file hash"; break;
          case -99:       returnMessage = "Missing or invalid session token"; break;
          case -203:      returnMessage = "Invalid Quickkey or File does not belong to session user"; break;
          case -204:      returnMessage = "User does not have write permissions to this file"; break;
          case -205:      returnMessage = "User does not have write permissions to the destination folder"; break;
          case -302:      returnMessage = "Attempting a resumable upload unit upload before "
                                              + "calling upload/pre_upload API"; break;
          case -303:      returnMessage = "Invalid unit size"; break;
          case -304:      returnMessage = "Invalid unit hash"; break;
          case -701:
          case -881:      returnMessage = "Maximum file size for free users exceeded"; break;
          case -700:
          case -882:      returnMessage = "Maximum file size exceeded"; break;
          case -10:
          case -12:
          case -26:
          case -50:
          ...
          case -140:
          case -200:
          case -301:      returnMessage = "Internal Server Errors"; break;
          default:        throw new IllegalArgumentException("Return code out of range : " + this.value);
        }
