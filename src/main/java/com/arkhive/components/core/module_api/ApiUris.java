...
public class ApiUris {
    public static final String URI_CONTACT_ADD = "/api/1.0/1.0/contact/add.php";
    ...
    public static final String URI_FOLDER_GET_CONTENT = "/api/1.0/folder/get_content.php";
